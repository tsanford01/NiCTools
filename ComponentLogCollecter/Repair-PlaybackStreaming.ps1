...
#Set-UserCreds
Write-Host "Repair Script Run" -ForegroundColor Yellow
$Done = "y"
Exit
...
#$computer = "localhost"
$Config = "\\$computer\d$\Program Files\NICE Systems\NICE Stream Server\Bin\NiceApplications.Playback.Streaming.Startup.exe.config"
